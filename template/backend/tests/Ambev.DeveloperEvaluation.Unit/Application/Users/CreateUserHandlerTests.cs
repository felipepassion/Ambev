...
namespace Ambev.DeveloperEvaluation.Tests.Unit.Application.Users
{
    ...
    public class CreateUserHandlerTests
    {
        ...
        public CreateUserHandlerTests()
        {
            ...
            _handler = new CreateUserHandler(_userRepository, _mapper, _passwordHasher, _mediator);
        }

        /// <summary>
        /// Tests that a valid user creation request is handled successfully,
        /// returns a success response and publishes a UserCreatedEvent.
        /// </summary>
        [Fact(DisplayName = "Given valid user data When creating user Then returns success response and publishes UserCreatedEvent")]
        public async Task Handle_ValidRequest_ReturnsSuccessResponse_AndPublishesEvent()
        {
            // Given
            ...
            // Verify that the UserCreatedEvent is published with correct properties
            await _mediator.Received(1)
                .Publish(Arg.Any<UserRegisteredEvent>(),
